{{ Form::model($data, array('route' => array('applicants.update', $data->id), 'method' => 'PUT', 'class'  => 'formSubmit','files'=>true )) }}
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Form::select('job', $careers, [$data->career_id], ['class' => 'form-control select2bs4']) }}
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Form::file('file', null, ['class' => 'form-control', 'placeholder' => 'Optional']) }}
        </div>
    </div>
</div>
